 ...
 */
public class CardboardOverlayViewTop extends LinearLayout {
  ...
  public CardboardOverlayViewTop(Context context, AttributeSet attrs) {
    super(context, attrs);
    ...
    textFadeAnimation.setDuration(50000);
  }
